...
void dma::arbiter(int name, int count) {
	...
	//while (true) {
		...
		cout << "grant 1 is " << gnt1->read() << endl;
		cout << "grant 2 is " << gnt2->read() << endl;
		cout << "grant 3 is " << gnt3->read() << endl;
		cout << "grant 4 is " << gnt4->read() << endl;
		cout << "grant 5 is " << gnt5->read() << endl;
